...
//存在チェック
$categoryStatement = $pdo->prepare("select categoryName from category where id = :inputId");
$categoryStatement->bindValue(":inputId", $_SESSION["editCategoryId"], PDO::PARAM_INT);
